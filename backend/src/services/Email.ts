...
export class Email {
  ...
  public static sendPasswordResetEmail(email: string, username: string, code: string): boolean {
    return this.sendEmail(
      email,
  ...
  public static sendNewPasswordEmail(email: string, username: string, newPassword: string): boolean {
    return this.sendEmail(
      email,
      'Your New Password',
